		...
		<div class="fusion-header">
			...
			<div class="fusion-row">
				...
				<div class="fusion-right">
					...
					<?php dynamic_sidebar('headder-social' );?>
		...
		<div class="fusion-logo" data-margin-top="<?php echo intval( Avada()->settings->get( 'margin_logo_top' ) ); ?>px" data-margin-bottom="<?php echo intval( Avada()->settings->get( 'margin_logo_bottom' ) ); ?>px" data-margin-left="<?php echo intval( Avada()->settings->get( 'margin_logo_left' ) ); ?>px" data-margin-right="<?php echo intval( Avada()->settings->get( 'margin_logo_right' ) ); ?>px">
			...
			<?php if ( Avada()->settings->get( 'logo' ) ) : ?>
				...
				<a class="fusion-logo-link" href="<?php echo home_url(); ?>">
					...
					<img src="<?php echo $logo_url; ?>" width="<?php echo $logo_size['width']; ?>" height="<?php echo $logo_size['height']; ?>" alt="<?php bloginfo( 'name' ); ?>" title="<?php bloginfo( 'name' ); ?>" class="fusion-logo-1x fusion-standard-logo" />
					...
					<?php if ( $retina_logo ) : ?>
						...
						<img src="<?php echo $retina_logo; ?>" width="<?php echo $logo_size['width']; ?>" height="<?php echo $logo_size['height']; ?>" alt="<?php bloginfo('name'); ?>" title="<?php bloginfo( 'name' ); ?>" <?php echo $style; ?> class="fusion-standard-logo fusion-logo-2x" />

					<?php else: ?>

						<img src="<?php echo $logo_url; ?>" width="<?php echo $logo_size['width']; ?>" height="<?php echo $logo_size['height']; ?>" title="<?php bloginfo( 'name' ); ?>" alt="<?php bloginfo('name'); ?>" class="fusion-standard-logo fusion-logo-2x" />
