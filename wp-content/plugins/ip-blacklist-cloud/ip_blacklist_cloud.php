...
function post_blacklist_add($IP)
{
    ...
    $context = stream_context_create (array ( 'http' => $contextData ));
    $link="http://www.ip-finder.me/blacklist_add.php?IP=".$IP."&website=".urlencode(site_url())."&website_name=".urlencode(get_bloginfo('name'));
...
function post_blacklist_remove($IP)
{
    ...
    $context = stream_context_create (array ( 'http' => $contextData ));
    $link="http://www.ip-finder.me/blacklist_delete.php?IP=".$IP."&website=".urlencode(site_url())."&website_name=".urlencode(get_bloginfo('name'));
...
function post_blacklist_add_multi($IPs)
{
  ...
  if($IPs)
  {
      ...
      $context = stream_context_create (array ( 'http' => $contextData ));
      $link="http://www.ip-finder.me/blacklist_add_multi.php?IP=".$IP_var."&website=".urlencode(site_url())."&website_name=".urlencode(get_bloginfo('name'));
...
function post_blacklist_remove_multi($IPs)
{
  ...
  if($IPs)
  {
      ...
      $context = stream_context_create (array ( 'http' => $contextData ));
      $link="http://www.ip-finder.me/blacklist_delete_multiple.php?IP=".$IP_var."&website=".urlencode(site_url())."&website_name=".urlencode(get_bloginfo('name'));
...
function post_blacklist_add_user($user)
{
    ...
    $link="http://www.ip-finder.me/blacklist_user_add.php?USER=".$user."&website=".urlencode(site_url())."&website_name=".urlencode(get_bloginfo('name'));
...
function post_blacklist_remove_user($user)
{
    ...
    $link="http://www.ip-finder.me/blacklist_delete_user.php?USER=".$user."&website=".urlencode(site_url())."&website_name=".urlencode(get_bloginfo('name'));
